            ...
            <div class="intro-text" style="padding-bottom:0px;padding-top: 450px;">
                ...
                <form class="form-inline">
                  <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Accession Number" style ="height: 54px;width:300px;">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputPassword3" placeholder="Organism Name" style ="height: 54px;width:300px;">
                  </div>
                  <button type="submit" class="btn btn-xl" style="padding: 13px;width: 210px;background-color:#3296b1;border-color:#3296b1">Search</button>
                </form>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="img/logo.jpg" class="img-responsive img-centered" alt="">
                    </a>
                </div>
