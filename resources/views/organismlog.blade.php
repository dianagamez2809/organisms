...
@section('content')
    ...
    <section id="services" class="bg-light-gray">
        <div class="container">
            <a class="btn btn-xl" href="{{ URL::to('organismlog/create') }}" style="float: right;margin-top: -100px;background-color: #32b159;
                ...
                <tbody>
                    @foreach($organisms as $key => $value)
                      <tr>
                        ...
                        <td>{!! $value->valid !!}</td>
                        <td>
                            <a class="btn btn-block btn-info" href="{{ URL::to('organismlog/' . $value->id . '/edit') }}">Edit</a>
                        </td>
                      </tr>
                    @endforeach
                </tbody>
