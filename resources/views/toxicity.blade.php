...
@section('content')
    ...
    <section id="services" class="bg-light-gray">
        <div class="container">
            <a class="btn btn-xl" href="{{ URL::to('toxicity/create') }}" style="float: right;margin-top: -100px;background-color: #32b159;
                ...
                <tbody>
                    @foreach($toxicities as $key => $value)
                      <tr>
                        ...
                        <td>{!! $value->humans !!}</td>
                        <td>
                            <a class="btn btn-block btn-info" href="{{ URL::to('toxicity/' . $value->id . '/edit') }}">Edit</a>
                        </td>
                      </tr>
                    @endforeach
                </tbody>
