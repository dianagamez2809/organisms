...
class OrganismsController extends Controller {
	...
	{
		return View::make('uploadorganismlog');
	}
	...
	public function store()
	{
        ...
        // process the login
        if ($validator->fails()) {
            return Redirect::to('organismlog/create')
            ...
            return Redirect::to('organismlog');
        }
	}
	...
	public function edit($id)
	{
        ...
        return View::make('editorganisimlog')
